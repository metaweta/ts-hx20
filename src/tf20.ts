...
// BOOT80.SYS and DBASIC.SYS loaded from external files
...
export class TF20 {
  ...
  // Boot binaries
  private boot80: Uint8Array = new Uint8Array(0);
  private dbasicRaw: Uint8Array = new Uint8Array(0);  // Original code section (un-relocated)
  private dbasicBitmap: Uint8Array = new Uint8Array(0); // PRL relocation bitmap
  ...
  /** Load BOOT80.SYS and DBASIC.SYS binaries (called after fetching from /roms/) */
  loadBootROMs(boot80: Uint8Array, dbasic: Uint8Array): void {
    this.boot80 = boot80;
    this.dbasicRaw = dbasic.slice(0, DBASIC_CODE_SIZE);
    this.dbasicBitmap = dbasic.slice(DBASIC_CODE_SIZE, DBASIC_CODE_SIZE + Math.ceil(DBASIC_CODE_SIZE / 8));
